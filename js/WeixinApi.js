var wx = {
	appId:'',
	imgUrl:'http://unitedasia.com.cn/p/lido/images/wlogo.jpg',
	link:'http://unitedasia.com.cn/p/lido/',
	title:'2015北京丽都维景酒店#摇祝福 · 送挚友#行动，赶快来参与吧！',
	desc:'摇一摇，把新年祝福与礼物送到给你久违重逢的朋友、亲人',
	fakeid:'',
	weiboContent:'摇一摇，把新年祝福与礼物送到给你久违重逢的朋友、亲人',
	scene:0,
	init:function(){
...
window.imgUrl = 'http://unitedasia.com.cn/p/lido/images/wlogo.png';
window.lineLink = !getUrl('playid') ? 'http://unitedasia.com.cn/p/lido/' :  "http://unitedasia.com.cn/p/lido/gamehelp.html?playid="+getUrl('playid')+"";
window.descContent = "摇一摇，把新年祝福与礼物送到给你久违重逢的朋友、亲人";
window.weiboContent = '摇一摇，把新年祝福与礼物送到给你久违重逢的朋友、亲人';
window.shareTitle = '2015北京丽都维景酒店#摇祝福 · 送挚友#行动，赶快来参与吧！' ;
window.appid = '';
window.isLast=false;
/*
// 初始化WeixinApi，等待分享
